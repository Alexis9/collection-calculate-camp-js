'use strict';
var one_add_next_multiply_three = require('../../../practices/superposition_operation/own_elements_operation/' +
  'one_add_next_multiply_three.js');
...
describe('one_add_next_multiply_three_spec', function() {
  ...
  iit('每一个数与下一个数相加，乘以3,最后一个数不算', function() {
